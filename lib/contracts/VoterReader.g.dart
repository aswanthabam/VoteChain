...
class VoterReader extends _i1.GeneratedContract {
  ...
  Future<List<dynamic>> getAllVoters(
    ...
    assert(checkSignature(function, '85149fc4'));
    final params = [
      constituency,
      startIndex,
      count,
  ...
  Future<List<dynamic>> getUnverifiedVoters(
    ...
    assert(checkSignature(function, '81afb4c6'));
    final params = [
      constituency,
      startIndex,
      count,
  ...
  Future<List<dynamic>> getUnverifiedVoters$2(
    ...
    assert(checkSignature(function, 'e19493b1'));
    final params = [
      constituency,
      count,
    ];
